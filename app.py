...
fig_2 = px.scatter(car_data, x='odometer', y='price') #crear scatter plot
fig_2.show() #mostrar scatter plot
...
scatter_button = st.button('Construir diagrama de dispersión') #botón para mostrar diagrama de dispersión
if scatter_button: #si se presiona el botón
    ...
    fig_2 = px.scatter(car_data, x='odometer') #crear histograma
    st.plotly_chart(fig_2, use_contained_width=True) #mostrar histograma    
